...
try {
  ...
  // Postavke -- the camera on the stop, and the Promet card as that stop's
  // arrivals board; with no stop it is the city's exceptions, and those read
  // the screen's own lines first.
