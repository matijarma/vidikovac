...
ZET je jedan od izvora u sedam područja i ne pokušavamo ga zamijeniti: Promet prikazuje vozila i kašnjenja linija, a za planiranje putovanja upućuje na postojeće aplikacije. Vrijednost je u spoju: upozorenje DHMZ-a, zatvorena prometnica, potres, akt Službenog glasnika i vijest na istom mjestu, u istoj minuti, s istim standardom atribucije. Kaj ima? se od aplikacije za jedno područje razlikuje po tom spoju, po javnim zaslonima koje vodi telefon, po otvorenom formatu kroz koji svaki izdavač u gradu objavljuje za sve zaslone i po skupu podataka o potražnji koji se vraća Gradu.
