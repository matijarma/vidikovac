...
| Z5 | WP1, WP3 | na zaslonu nema upravljanja | kao Z1, `npm run accept -- test/accept/trust.test.ts -t d-controls` | 0 kontrola osim marke i QR-a; Postavke samo držanjem marke 900 ms; podnožje bez HH:MM | §16.3, §16.5 | – | `725991c`: 0 kontrola u prvom očitanju i u svih 300 u svakom prizoru; Postavke samo držanjem od 900 ms u 8 prizora; podnožje bez HH:MM; `d-controls-invitation` i `d-controls-presentation` zeleni (`10ed458`); `ea5439e0` (D5.8, provjera izdanja u pregledniku): 0 kontrola, podnožje bez sata; produkcija na D5.8 (24. 9. od 13:37 do 13:50): `controls` i `footer-clock` 0 | prolazi |
