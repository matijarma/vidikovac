...
jedna isporuka 24. rujna 2026.). Na kandidatima D2 motor kretanja i artefakti mreže bajtno su isti
kao na D1; graf s grane `lane/t-rail` stiže s D3. Crtica znači da se redak na toj
...
grane `lane/t-rail` to je učinjeno na `8e91bcdd` (graphHash `c7e6e555d9845ffd`), a test sada
uspoređuje README s artefaktom.
...
uzorku A na 1,33 i A′ na 0, a E, G i H ostaju crveni (`d52cc47b`).

| # | Paket | Mjera | Naredba | Prag | Izvor | D1: ned 20. 9. / pon 21. 9. | Poslije D1 (glava uz vrijednost) | Ocjena |
|---|---|---|---|---|---|---|---|---|
| A1 | WP0 | A: promjene staze unutar iste vožnje na 100 vozilo-sati tramvaja | `npm run replay:grade -- <dan> --out <prefiks> --targets stage1` | ≤ 5 (drugi stupanj ≤ 1) | §16.2 | 21,44 / 12,25 | D2 (`725991c`) kao D1; `bd86ebb6` (D3, oba dana): 17,97 / 3,20 | ne prolazi u nedjelju (260 od 285 događaja je nedjeljni obilazak linije 11, za koji feed 000395 nema oblik); ponedjeljak prolazi |
| A2 | WP0 | A′: isto u kvadratu središta, 17:15 do 17:44 | kao A1 | ≤ 5 | §16.2 | 41,7 (7 događaja) / 18,7 (6 događaja) | D2 (`725991c`) kao D1; `bd86ebb6` (D3, oba dana): 23,8 (4 događaja) / 0 | ne prolazi u nedjelju; ponedjeljak prolazi |
| A3 | WP0 | B: preuzimanja staze druge linije | kao A1 | 0 | §16.2 | 0 / 0 | D2 (`725991c`) kao D1; `bd86ebb6` (D3, oba dana): 0 / 0 | prolazi |
| A4 | WP0 | C: vozilo-sati na tuđoj stazi; svježa očitanja na tuđoj stazi | kao A1 | 0; 0 | §16.2 | 0; 0 / 0; 0 | D2 (`725991c`) kao D1; `bd86ebb6` (D3, oba dana): 0; 0 / 0; 0 | prolazi |
| A5 | WP0 | D: vlastita staza među mogućima, a odabrana druga inačica | kao A1 | 0 | §16.2 | 0 / 0 | D2 (`725991c`) kao D1; `bd86ebb6` (D3, oba dana): 0 / 0 | prolazi |
| A6 | WP0 | E: promjene smjera dalje od 300 m od okretišta | kao A1 | 0 | §16.2 | 4 / 7 | D2 (`725991c`) kao D1; `bd86ebb6` (D3, oba dana): 8 / 10, od toga 4 i 5 predaja petlje dalje od 300 m od okretišta | ne prolazi |
| A7 | WP0 | F: vožnje unatrag po luku od 500 m i više | kao A1 | 0 | §16.2 | 0 / 0 | D2 (`725991c`) kao D1; `bd86ebb6` (D3, oba dana): 0 / 0 | prolazi |
| A8 | WP0 | G: ponovna postavljanja oznake na klijentu za više od 50 m; p95 pomaka | kao A1 | 0; < 50 m | §16.2 | 1.203; 253,9 m / 1.232; 226,2 m | D2 (`725991c`) kao D1; `bd86ebb6` (D3, oba dana): 416; 142,8 m / 261; 131,4 m | ne prolazi |
| A9 | WP0 | H: vidljiva korekcija pri ponovnom izvođenju, p95 | kao A1 | < 60 m | §16.2 | 250 m / 226 m | D2 (`725991c`) kao D1; `bd86ebb6` (D3, oba dana): 260 m / 230 m | ne prolazi |
| A10 | WP0 | U: tramvaj bez staze, bez razdoblja stajanja u spremištu ili na okretištu | kao A1 | ≤ 0,03 | §16.2 | 0,0289 / 0,0226 (sirovo 0,0364 / 0,0300) | D2 (`725991c`) kao D1; `bd86ebb6` (D3, oba dana): 0,0208 / 0,0114 (sirovo 0,0251 / 0,0153) | prolazi |
| A11 | WP0 | S1 i S2: rok izbacivanja; objavljena vozila starija od roka; tihi tramvaji planirani preko idućeg stajališta | kao A1 | 180 s; 0; 0 | §16.2, [O-63] | 180 s; 0; 0 / 180 s; 0; 0 | D2 (`725991c`) kao D1; `bd86ebb6` (D3, oba dana): 180 s; 0; 0 / 180 s; 0; 0 | prolazi |
| A12 | WP0 | nepoznate vožnje u snimci | kao A1 | ≤ 1 % | §16.2 | 0,049 % / 0,145 % | D2 (`725991c`) kao D1; `bd86ebb6` (D3, oba dana): 0,049 % / 0,145 % | prolazi |
| A13 | WP0 | kapija kruga F na 20. 9.: slike unatrag, obrati, preticanja, vidljiva križanja, otkucaj p50 | `node scripts/replay-twin.mjs <dan>` | 0; 0; 0; ≤ 2.478; < 60 ms | §16.2 | 0; 0; 0; 1.552; 26,79 ms / – | D2 (`725991c`) kao D1; `bd86ebb6`: 0; 0; 0; 1.529; 41,63 ms (p50 uz dijeljeno računalo; na grani `lane/t-rail` 26,50 ms) | prolazi |
| A14 | WP0, WP6 | provjera tipova i testovi | `npm run typecheck && npm run typecheck:tests && npm test` | zeleno, 0 pogrešaka u četiri programa | §16.1 | 3.068 testova u 223 datoteke, 0 pogrešaka u četiri programa / – | `92950b17` (kandidat izdanja): 4.727 testova u 258 datoteka, 0 pogrešaka u četiri programa; `2d46817`: 4.598 testova u 247 datoteka | prolazi |
| A15 | WP0 | artefakt mreže: bez dugih dionica, najmanje 20 okretišnih petlji, isti bajtovi pri ponovnoj gradnji | `npm run build:network -- --zip <arhiva> --built-at <vrijeme>`, `npm run build:schema -- --check` | ≥ 20 petlji; isti bajtovi | §16.2 | 30 petlji, od toga 7 bez crteža na shemi (`loop-undrawn`); isti bajtovi / – | D2 (`725991c`) kao D1; `bd86ebb6`: artefakt grane `lane/t-rail` (graphHash `c7e6e555d9845ffd`), 71 okretišna petlja, od toga 18 bez crteža na shemi, 145 od 152 staze na nacrtu, `npm run build:schema -- --check` izlazni kod 0 | prolazi |
| A16 | WP0, WP2 | oznake vozila bez „+N” i bez skraćivanja popisa linija | `npm run accept -- test/accept/trust.test.ts -t pills`, `npm run e2e -- e2e/round-f.spec.ts e2e/schema.spec.ts` | 0 oznaka s „+N” | §16.3, §16.5 | 0 od 21.645 oznaka u 280 uzoraka (najviše 9 linija u oznaci); `round-f` i `schema` 11 od 11 / – | `725991c`: 0 oznaka s „+N” u 300 očitanja svakog od 8 prizora i u deset minuta uživo (161 različita oznaka, sve u jednom retku); `c-pills` i `c-no-fold` zeleni; `48cb09f`: `round-f` 3 od 3 | prolazi |
...
| Z11 | WP6 | snimači preglednika | kao Z1, blok (I) | greške konzole i stranice, neuspjeli zahtjevi i odgovori HTTP ≥ 400: 0 | §16.3 | – | `725991c`: 0 u svih 9 prizora | prolazi |
