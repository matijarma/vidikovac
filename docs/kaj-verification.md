...
| A19 | WP0 | na zaslonu nema kontrole za završetak prikaza | `npm test -- test/app/kiosk.test.ts test/app/kiosk-css.test.ts`, `npm run e2e -- e2e/pairing.spec.ts` | 0 | §16.5 | 120 od 120, uparivanje 3 od 3 / – | `d-presentation` i `d-presentation-source` zeleni; preglednik: mjeri se u prolazu D2-e2e, na čekanju | prolazi |
...
| Z12 | WP1 do WP4 | oznake `data-testid` iz ugovora §15.6 | `npm run accept -- test/accept/probes.test.ts` | 0 crvenih | §15.6 | – | zelenih 54, crvenih 13: `stop-board` (WP2, dodir na zaslonu, D3) i 12 redaka paketa WP4 (D3) | prolazi za WP1 do WP3 |
