...
const HR = {
  ...
  coopWindows: 'Kartu zumiraj s Ctrl i kotačićem',
  coopMac: 'Kartu zumiraj s ⌘ i kotačićem',
  coopMobile: 'Kartu pomiči dvama prstima',
  closuresNow_one: '{count} zatvaranje',
  closuresNow_few: '{count} zatvaranja',
  closuresNow_other: '{count} zatvaranja',
  allClosures: 'sve zatvaranja ({count})',
  allStops: 'sve stanice ({count})',
  ...
  windowFromUntil: 'od {from} do {until}',
  lightSearch: 'Traži liniju',
  lightSearchLabel: 'Pretraga linija u pokretu',
  lightNoResults: 'Nijedna linija u pokretu ne odgovara „{query}”.',
};
...
const EN: Record<keyof typeof HR, string> = {
  ...
  coopWindows: 'Use Ctrl + scroll to zoom the map',
  coopMac: 'Use ⌘ + scroll to zoom the map',
  coopMobile: 'Use two fingers to move the map',
  closuresNow_one: '{count} closure',
  closuresNow_few: '{count} closures',
  closuresNow_other: '{count} closures',
  allClosures: 'all closures ({count})',
  allStops: 'all stops ({count})',
  ...
  windowFromUntil: 'from {from} to {until}',
  lightSearch: 'Search a route',
  lightSearchLabel: 'Search the routes running now',
  lightNoResults: 'No route running now matches “{query}”.',
};
