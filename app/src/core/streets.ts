// The offline street index behind the public screen's place field
// ("Adresa ili stajalište", kiosk/place-field.ts): decoded from
// app/public/data/streets-geo.json on the field's first use. The wall's
// setup alone reads it, so it is a module of its own rather than a part of
// core/screens.ts, which the phone's lightweight graph carries
