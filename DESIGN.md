...
The time band organizes Sada by time, not by domain. Promet is an interactive map stage with a detail sheet. The desktop has a Kvart aside; the phone uses Sada, Promet, Kvart and Još tabs. The kiosk retains a map field across its chapters, with measured overlays and a separate invitation rail.
