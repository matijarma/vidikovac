...
// without a plan is a plain fix; the route rows become the delay map.
    ...
    const fixes = vehicleFixes(snapshot([
      {
        ...
        data: { routeId: '6', tripId: 'T1', vehicleId: '1', routeShortName: '6', routeType: 0, direction: 0, headsign: 'Sopot', shapeId: '6_25', nextStopId: '231_2', delaySeconds: 45, speed: 9.5, confidence: 0.9, held: false, behind: 'vehicle:9' },
