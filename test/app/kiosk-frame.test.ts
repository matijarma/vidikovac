...
describe('stripMarkup', () => {
  const strip = frameStrip(CALM_MODULES, STOP, i18n, s, NOW);
  it('one row (kajimafix 03.5): the shield kicker, the verdict with its glyph as the button that opens Osnovno, the sources with the moment they confirmed calm, the pharmacy, the /hitno pill; no countdown, no closures cell, no Osnovno chip', () => {
