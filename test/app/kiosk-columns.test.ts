...
// wall keeps them. WP5 B1 deleted experience/timeband.ts and its tests; the
// worked examples of plan A.3 (the cuts at 18:00 and at the service day's
// 04:00, the labels, the DST nights) moved here, onto the module the wall
// imports.
